---
description: "Required workflow for Azure DevOps work item tracking, Git branching, pull requests, and branch cleanup in the GHAzDO-Export project."
applyTo: "**"
maturity: stable
---
